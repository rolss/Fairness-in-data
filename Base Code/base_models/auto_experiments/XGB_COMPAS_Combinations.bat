...
papermill "Reweight_COMPAS_BINARY Model XGB.ipynb" "results/COMPAS/output_sex_race_XGB_COMPAS.ipynb" -p sensible_attribute "sex-race"

echo.
echo Running age-race combination...
papermill "Reweight_COMPAS_BINARY Model XGB.ipynb" "results/COMPAS/output_age_race_XGB_COMPAS.ipynb" -p sensible_attribute "age-race"
